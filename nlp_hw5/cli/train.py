...
def preprocess_function(
    ...
    # This is because we have a special token called BOS at the first position
    ...
    # By shifting the target text by one token,
    # the decoder would be able to learn how predict the next word if previous words were given.
    ...
    *,
    ...
    for batch in tqdm(dataloader, desc="Evaluation"):
        with torch.inference_mode():
            ...
            # (1) model.forward() calls the forwards() function and model.generate() is an output
